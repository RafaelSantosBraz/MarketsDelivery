 ...
 */
public class ComporCarrinho extends javax.swing.JFrame {

    /**
     * Creates new form AlterarProduto
     */
    public ComporCarrinho() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ComporCarrinho.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ComporCarrinho().setVisible(true);
            }
        });
    }
